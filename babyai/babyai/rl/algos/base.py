...
class BaseAlgo(ABC):
    ...
    def __init__(self, envs, acmodel, num_frames_per_proc, discount, lr, gae_lambda, entropy_coef,
                 ...
                 reshape_reward, aux_info, use_compositional_split=False, compositional_test_splits=None, device=None):
        """
        ...
        self.intr_rewards = torch.zeros(*shape, device=self.device)
    ...
    def collect_experiences(self):
        ...
        for i in range(self.num_frames_per_proc):
            ...
            with torch.no_grad():
                ...
                intrinsic_rew = model_results['intrinsic_rew']
            ...
            if self.reshape_reward is not None:
                ...
                self.intr_rewards[i] = self.rewards[i] + intrinsic_rew.to(device)
        ...
        for i in reversed(range(self.num_frames_per_proc)):
            ...
            delta = self.intr_rewards[i] + self.discount * next_value * next_mask - self.values[i]
        ...
        exps.reward = self.intr_rewards.transpose(0, 1).reshape(-1) 
