    ...
    def collect_experiences(self):
        ...
        for i in range(self.num_frames_per_proc):
            ...
            with torch.no_grad():
                ...
                # DIAYN-like intrinsic reward
                # rule_ids = model_results['rule_ids']
            ...
            self.rewards[i] = torch.tensor(reward, device=self.device) + intrinsic_rew.to(self.device) # intrinsic_rew is zero by default
